...
# Each interaction is a stand alone interaction
# The model does not remember the previous interactions
# Need to provide the context of the previous interactions
def func4():
    messages = [
        {"role": "system", "content": "You are friendly chatbot."},
        {"role": "user", "content": "Hi, my name is Isa"},
